<template>
  <div class="relative">
    ...
    <div v-if="isOpen" class="absolute z-20 right-0 mt-2 py-2 w-48 bg-white rounded-lg shadow-xl">
      ...
      <a :href="route('profile.show', user)" class="block px-4 py-2 text-gray-900 hover:bg-francaverde transition duration-500 ease-in-out transform hover:-translate-y-1">
      ...
      <a :href="route('admin.index')" v-if="isAdmin" class="block px-4 py-2 text-gray-900 hover:bg-francaverde transition duration-500 ease-in-out transform hover:-translate-y-1">
      ...
      <a :href="route('contact.create')" class="block px-4 py-2 text-gray-900 hover:bg-francaverde transition duration-500 ease-in-out transform hover:-translate-y-1">
      ...
      <a href="#" @click.prevent="logout" class="block px-4 py-2 text-gray-900 hover:bg-francaverde transition duration-500 ease-in-out transform hover:-translate-y-1">

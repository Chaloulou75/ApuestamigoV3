  ...
  <div class="relative">
    ...
    <transition name="slide-fade">     <!-- des supers transitions -->
      ...
      <div v-if="isOpen" class="absolute z-50 right-0 mt-2 py-2 w-48 bg-francagris border-2 border-francaverde rounded-lg shadow-xl"> <!--  -->
          ...
          <a :href="route('profile.show', user)" class="block px-4 py-2 text-white hover:text-francaverde"> 
          ...
          <a :href="route('admin.index')" v-if="isAdmin" class="block px-4 py-2 text-white hover:text-francaverde">
          ...
          <a :href="route('contact.create')" class="block px-4 py-2 text-white hover:text-francaverde">
          ...
          <a href="#" @click.prevent="logout" class="block px-4 py-2 text-white hover:text-francaverde">

<template>
  <header
    class="bg-francagris text-white border-b-4 border-francaverde sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3"
  >
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="sm:block">
      ...
      <div class="px-2 py-1 sm:hidden" v-if="isAuthenticated">
        ...
        >
          <img
            class="h-8 w-8 border border-francaverde rounded-full object-contain overflow-hidden bg-white"
            src="/img/cup.png"
            loading="auto"
            alt="cup"
          />
          <span class="ml-3 hover:text-francaverde">
        ...
        <div class="mt-1">
          ...
          >
            <svg
              class="h-5 w-6 inline-block pr-1"
              fill="none"
              stroke-linecap="round"
              stroke-linejoin="round"
              stroke-width="2"
          ...
          >
            <svg
              class="h-5 w-5 inline-block pr-1"
              fill="none"
              stroke-linecap="round"
              stroke-linejoin="round"
              stroke-width="2"
          ...
          >
            <svg
              class="h-6 w-6 inline-block pr-1"
              fill="none"
              stroke-linecap="round"
              stroke-linejoin="round"
              stroke-width="2"

<template>
  <header class="bg-gray-900 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3">
    <div class="flex items-center justify-between px-4 py-3 sm:p-0">
      <div>
        <!-- <img class="h-8" src="/img/uefa.png" alt="Apuestamigo"> -->
        <a :href=" '/' " class="block px-2 py-1 text-white text-2xl rounded hover:bg-gray-800"> Apuestamigo
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="sm:block">
      <div class="px-2 pt-2 pb-4 sm:flex sm:p-0">
        <a href="#" class="block px-2 py-1 text-white font-semibold rounded hover:bg-gray-800"><i class="fas fa-award pr-1"></i> Mes ligues </a>
        <a href="#" class="mt-1 block px-2 py-1 text-white font-semibold rounded hover:bg-gray-800 sm:mt-0 sm:ml-2"><i class='far fa-hand-point-right pr-1'></i>Créer une ligue</a>
        <a :href="'/contact'" class="mt-1 block px-2 py-1 text-white font-semibold rounded hover:bg-gray-800 sm:mt-0 sm:ml-2"><i class='far fa-envelope pr-1'></i>Contact</a>
      ...
      <div class="px-4 py-5 border-t border-gray-800 sm:hidden">
        <div class="flex items-center">
          ...
          <span class="ml-3 font-semibold text-white">Bobby<!-- {{ Auth::user()->name }} --></span>
        </div>
        <div class="mt-4">

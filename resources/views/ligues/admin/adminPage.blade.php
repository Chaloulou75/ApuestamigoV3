...
<div class="w-full md:w-4/5 mx-auto p-1">
	...
	<div class="flex flex-wrap">
		...
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">	
		<a href="{{ route('apuestas.compare', [ $journee = 1]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
		 	Points/Match pour la journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 2]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
		 Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 3]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
		 	Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 4]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
		 	Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 5]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 6]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 7]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 8]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>	
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 9]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 10]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 11]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 12]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.compare', [ $journee = 13]) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"></path></svg>
			Points/Match pour la journée <strong>{{ $journee }}</strong>
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 1] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
		 	Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 2] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
		 	Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 3] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
		 	Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 4] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 	
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 5] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 6] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 7] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 8] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 9] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 10] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 11] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 12] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>
		<div class="animate__animated animate__flipInX border-2 rounded-lg border-francaverde flex-auto text-white text-center bg-francagris hover:text-francaverde px-4 py-2 m-2">
		<a href="{{ route('apuestas.points', [ $journee = 13] ) }}">
			<svg class="inline w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path></svg>
			Points totaux/Joueur/ligue/journée <strong>{{ $journee }}</strong> 
		</div>	
	</div>

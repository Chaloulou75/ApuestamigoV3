<div>
    <a wire:click="logout" 
         class="mt-1 block px-2 lg:px-4 py-2 text-sm cursor-pointer leading-none rounded hover:text-francaverde transition duration-500 ease-in-out transform hover:translate-x-2">

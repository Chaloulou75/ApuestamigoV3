...
<div class="w-full md:w-4/5 mx-auto p-1">
    ...
    <p class="text-base text-center text-francaverde py-2">
        <a href="{{route('datejournees.index')}}">Retourner à la liste des journées
        </a>
    </p>
        ...
        <form class="mx-auto" method="POST" action="{{ action('DateJourneeController@store') }}">
            ...
            <div class="mb-4">
                ...
                <select
                    ...
                    id="namejournee" name="namejournee" placeholder="{{old('namejournee')}}">
            ...
            <div class="mb-4">
                ...
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-900 leading-tight focus:outline-none focus:shadow-outline"
                    type="datetime-local" id="timejournee" name="timejournee" value="">
            </div>

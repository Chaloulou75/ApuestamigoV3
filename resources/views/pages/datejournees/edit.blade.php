        ...
        <form class="mx-auto" method="POST" action="{{ route('datejournees.update', $datejournee) }}">
            ...
            <div class="mb-4">
                ...
                <select id="championnat_id"
                    ...
                    name="championnat_id" value="{{ old('championnat_id') }}"
                    placeholder="{{$datejournee->championnat_id}}" required>
            ...
            <div class="mb-4">
                ...
                <select
                    ...
                    id="namejournee" name="namejournee" placeholder="{{$datejournee->namejournee }}">

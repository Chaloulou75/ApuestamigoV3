...
<div class="w-full md:w-4/5 mx-auto p-1">
    ...
    <div class="flex flex-wrap">
        ...
        <div
            class="animate__animated animate__flipInX border rounded-lg border-francaverde flex-auto text-white text-center text-xs bg-francagris hover:text-francaverde px-4 py-2 m-2">

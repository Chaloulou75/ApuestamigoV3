...
<div class="w-full max-w-xs lg:max-w-xl lg:w-2/3 m-auto p-auto pt-8">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('contact.store') }}">
        ...
        <div class="mb-4">
            <label for="name" class="block text-gray-700 text-base font-bold mb-2">{{ __('Nom') }}</label>
        ...
        <div class="mb-4">
            <label for="email" class="block text-gray-700 text-base font-bold mb-2">{{ __('Adresse e-mail') }}</label>
        ...
        <div class="mb-4">
            <label for="msg" class="block text-gray-700 text-base font-bold mb-2">{{ __('Message') }}</label>

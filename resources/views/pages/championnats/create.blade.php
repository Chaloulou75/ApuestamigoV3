...
<div class="w-full md:w-4/5 mx-auto">
    ...
    <div class="border-t-4 border-double border-francaverde bg-francagris">
        <h1
            ...
            Insérer un nouveau championnat</h1>
    </div>

    </h1>
    <p class="text-base text-center text-francaverde py-2"><a href="{{route('championnats.index')}}">Retourner à la
            liste des championnats</a></p>
    ...
    <div class="w-full lg:w-1/2 mx-auto bg-francagris shadow-md border-2 border-white rounded py-8 px-8 my-4">
        <form class="mx-auto" method="POST" enctype="multipart/form-data"
            action="{{ action('ChampionnatController@store') }}">
            @csrf
            @honeypot
            <div class="mb-4">
                <label for="name"
            ...
            <div class="mb-4">
                ...
                <input id="logo" type="file"
                    ...
                    name="logo" value="" required autocomplete="logo">

...
<div class="w-full md:w-4/5 mx-auto my-4">
    ...
    <h3 class="animate__animated animate__flipInX text-base text-center tracking-wide text-white py-2">
        {{__('all.Wanna`\' buy me a beer?') }}<span class="text-francaverde"> <svg class="h-5 w-5 inline" fill="none"
    ...
    <div
        class="animate__animated animate__zoomInUp w-full max-w-md md:w-2/5 mx-auto my-4 rounded overflow-hidden bg-gray-100 shadow-lg">
        {{-- <img class="w-full" src="/img/titreprog.jpg" alt="programme"> --}}
        <img src="/img/misc/beer.jpg" loading="auto"
            class="fill-current object-cover w-40 h-40 rounded-full mx-auto p-2" alt="beer">
            ...
            <form action="{{ route('donate.store') }}" method="post" id="payment-form">
                ...
                <div class="mb-2">
                    <label for="email" class="block text-francagris text-sm mb-1">
                        <svg class="h-4 w-4 inline" fill="none" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="mb-2">
                    ...
                    <input id="cardholdername" type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline
		             @error('cardholdername') bg-red-dark @enderror" name="cardholdername"
                        value="{{ old('cardholdername') }}" required autocomplete="cardholdername">
                ...
                <button id="card-button"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    Buy me a beer! 5
                    <svg class="h-6 w-6 inline" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path

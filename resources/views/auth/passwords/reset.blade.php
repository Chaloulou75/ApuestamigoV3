    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">{{ __('all.Reset Password') }}
        ...
        <div class="flex-auto p-6">
            <form  method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-4">
                    <label for="email" class="block text-gray-700 text-base font-medium mb-2">{{ __('all.E-Mail Address') }}</label>
                ...
                <div class="mb-4">
                    <label for="password" class="block text-gray-700 text-base font-medium mb-2">{{ __('all.Password') }}</label>
                ...
                <div class="mb-4 ">
                    <label for="password-confirm" class="block text-gray-700 text-base font-medium mb-2">{{ __('all.Confirm Password') }}</label>
                ...
                <div class="mb-4">
                    <div class="flex items-center justify-between">
                        <button type="submit" class="bg-teal-500 hover:bg-teal-700 text-white font-medium py-2 px-4 rounded focus:outline-none focus:shadow-outline">

    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">{{ __('Reset Password') }}
        ...
        <div class="flex-auto p-6">
            <form  method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-4">
                    <label for="email" class="block text-gray-700 text-base font-bold mb-2">{{ __('Addresse E-Mail') }}</label>
                ...
                <div class="mb-4">
                    <label for="password" class="block text-gray-700 text-base font-bold mb-2">{{ __('Password') }}</label>
                ...
                <div class="mb-4 ">
                    <label for="password-confirm" class="block text-gray-700 text-base font-bold mb-2">{{ __('Confirm Password') }}</label>

...
<div class="w-full max-w-xs lg:w-1/3 m-auto p-auto pt-8">
    <div class="bg-francagris border border-francaverde text-white text-center shadow-md rounded px-8 pt-6 pb-8 mb-4">{{ __('all.Reset Password') }}
        ...
        <div class="flex-auto text-left p-6">
            <form  method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-4">
                    <label for="password" class="block text-white text-sm font-medium mb-2">{{ __('all.Password') }}</label>
                ...
                <div class="mb-4 ">
                    <label for="password-confirm" class="block text-white text-sm font-medium mb-2">{{ __('all.Confirm Password') }}</label>
                ...
                <div class="mb-4">
                    <div class="flex items-center justify-between">
                        <button type="submit" class="bg-francagris border border-francaverde text-sm text-white hover:text-francaverde font-medium py-2 px-4 rounded focus:outline-none focus:shadow-outline">

		  ...
		  <div class="border border-teal-400 rounded bg-teal-300 p-4 flex flex-col justify-between">
		    <div class="mb-8">
			    ...
			    <div class="text-center">
			      	<a href="{{ route('ligues.show', $ligue) }}" class="bg-teal-400 hover:bg-teal-500 text-orange-700 text-xl text-center uppercase py-2 px-4 border-b-2 border-teal-700 hover:border-teal-400 rounded">
						{{ $ligue->name }}
					</a>
				</div>		      				      		
		    </div>

...
<div class="w-full lg:w-3/4 m-auto p-1">
	<div class="border-2 border-solid rounded border-gray-600 bg-gray-900 mb-4 p-1">
		<h1 class="text-center text-white text-3xl font-bold">{{ __('nav.ligues')}} Apuestamigo</h1>
	</div>
	...
	<div class="flex flex-wrap items-stretch content-start justify-around my-4">
	   ...
	   @endforeach
		...
		<div class="flex-grow lg:w-1/3 justify-around m-4 border-2 border-white rounded bg-gray-900 p-4 shadow-xl focus:shadow-outline">	    

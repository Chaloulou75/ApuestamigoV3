...
<div class="w-full lg:w-3/4 m-auto p-1">
	<div class="border-t-4 border-double border-julienred bg-transparent mb-4 p-1">
		<h1 class="text-center text-gray-800 text-3xl tracking-wider font-semibold">{{ __('nav.ligues')}} Apuestamigo</h1>
	</div>
	...
	<div class="flex flex-wrap items-stretch content-start justify-around my-4">
		...
		<div class="flex-grow lg:w-1/3 justify-around m-4 shadow-lg focus:shadow-outline animated bounceInDown">
		  <div class="border-4 border-teal-600 rounded bg-teal-100 p-4 flex flex-col justify-between">
		    <div class="mb-8">
	   ...
	   @endforeach
		...
		<div class="flex-grow lg:w-1/3 justify-around m-4 border-4 border-julienred rounded bg-teal-700{{-- bg-gray-900 --}} p-4 shadow-xl focus:shadow-outline animated bounceInUp">	    

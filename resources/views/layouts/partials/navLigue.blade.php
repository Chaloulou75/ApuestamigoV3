<div class="border-2 border-solid rounded border-white text-white bg-gray-900 mb-4 p-1">
  ...
  <div class="sm:flex block justify-between text-sm lg:text-base p-2">
    <div class="w-auto border-2 border-solid rounded-full border-white flex-grow text-center hover:text-gray-900 text-white bg-gray-900 hover:bg-white font-medium px-4 py-2 m-1">

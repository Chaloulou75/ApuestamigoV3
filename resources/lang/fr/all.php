...
'A fresh verification link has been sent to your email address.'=> 'Un nouveau lien de vérification a été envoyé à votre adresse email.',
    ...
    'After you have registered and / or identified, create a league with your friends or colleagues (or more, there is no limit of players per league, but it\'s still much more fun with your friends and acquaintances). You will challenge your friends during a Champions League season until the evening of the final to find out who is the best tipster in the band.' => 'Après vous être enregitré et/ou identifié, créez une ligue avec vos potes ou collègues (ou plus, il n\'y a pas de limite de joueurs par ligue, mais c\'est quand même autrement plus fun avec ses potes et connaissances). Vous vous defierez ENTRE VOUS pendant une saison de ligue des Champions jusqu\'au soir de la finale pour savoir qui est le meilleur pronostiqueur de la bande.',
